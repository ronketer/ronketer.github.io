...
├── assets/images/      ← SVG project placeholders (threads, mapreduce, slam — still used; mosaicing/todo/anki archived)
└── assets/videos/      ← demo videos: demo_stereo_mosaicing.mp4, demo_procedural_game_engine.mp4, demo_todo_app.mp4
...
4. Stereo Mosaicing (`ronketer/Stereo-Mosaicing`) — demo: `demo_stereo_mosaicing.mp4`
5. Procedural Game Engine (`ronketer/procedural-game-engine`) — demo: `demo_procedural_game_engine.mp4`
6. Full-Stack Todo Application (`ronketer/todo-app`) — demo: `demo_todo_app.mp4`
