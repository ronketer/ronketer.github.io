...
└── assets/images/      ← 4 hand-crafted SVG project placeholders (threads, slam, anki, todo)
...
This is Ron Keter's personal portfolio. Exactly 4 projects are shown — do not add others:
1. User-Level Threads Library (`ronketer/user_level_threads`)
2. Stereo Visual SLAM (`ronketer/kitti_visual_slam`)
3. Autonomous Knowledge→Anki Pipeline (`ronketer/siyuan_to_anki`)
4. Secure Todo REST API (`ronketer/todo_list_api`)
